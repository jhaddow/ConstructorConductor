...
//Let's say three people signed up for our service, create 3 intances of User and add each to the users Array
 ...
 users.push(new User('Jess', 'jess.haddow@gmail.com', 'iLoveSports', 0));
 users.push(new User('Billy', 'billythekid@yahoo.com', 'Goober', 0));
 users.push(new User('Jerry', 'originalFunnyGuy@nbc.com', 'Newman!', 0));
...
//Fill in the rest of the required data as you see appropriate.
 ...
 var q1 = new Question('T/F: Inheritance is achieved in JavaScript through Prototypes?', ['T', 'F'], 'T', 3);
...
for(var i=0; i < questions.length; i++) {
	if(questions[i].hasOwnProperty('title')) {
